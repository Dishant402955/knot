...
const UseCases = () => {
    return <div className="h-full w-full flex justify-center px-[5%] py-24" id="use-cases">
        <div className="flex-col">
            <div className="flex-col justify-center items-center space-y-4">
                <p className="text-4xl font-bold flex justify-center items-center">USE CASES</p>
                <p className="text-2xl flex justify-center items-center"> Made for modern async teams    </p>
            </div>
...
>
  ...
  <path
    d="M248 115L261 123L248 131V115Z"
    fill="#A3A3A3"
  />
</svg>
}
