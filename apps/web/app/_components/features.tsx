...
const Features = () => {
    return <div className="h-full w-full flex justify-center px-[5%] py-24" id="features">
        <div className="flex-col">
            <div className="flex-col justify-center items-center space-y-4">
                <p className="text-4xl font-bold flex justify-center items-center">FEATURES</p>
                <p className="text-2xl flex justify-center items-center">Built for async work  </p>
            </div>
...
<Mock3/>
                    ...
                    <CardFooter>
Share a single link with anyone instantly. 
                    </CardFooter>
                </Card>
            </div>
        </div>
