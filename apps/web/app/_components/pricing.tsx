...
const Pricing = () => {
    return <div className="h-full w-full flex justify-center px-[5%] py-24 mb-30" id="pricing">
        <div className="flex-col">
            <div className="flex-col justify-center items-center space-y-4">
                <p className="text-4xl font-bold flex justify-center items-center">PRICING</p>
                <p className="text-2xl flex justify-center items-center"> Flexibility is out first priority   </p>
            </div>
